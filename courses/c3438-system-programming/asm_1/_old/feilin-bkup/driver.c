...
#if        1
        ret = request_irq(IRQ_ADC+1, adcdone_int_handler, IRQF_SHARED, DEVICE_NAME, &adcdev);
        if (ret) {
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("fffffffffff");
MODULE_DESCRIPTION("MyADC driver");
