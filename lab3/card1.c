...
void analyze_hand(int [][2], bool*, bool*, bool*, bool*, bool*, int*);
void print_result(bool, bool, bool, bool, bool, int);
...
int main(void)
{
  ...
  for (;;) {
    read_cards(hand);
    analyze_hand(hand, &royal_flush, &straight, &flush, &four, &three, &pairs);
 ...
 ****************************************************************/
void analyze_hand(int hand[][2], bool* royal_flush, bool* straight, bool* flush, bool* four, bool* three, int* pairs)
{
 ...
 *               and pairs.                               *
 **********************************************************/
void print_result(bool royal_flush, bool straight, bool flush, bool four, bool three, int pairs)
{
